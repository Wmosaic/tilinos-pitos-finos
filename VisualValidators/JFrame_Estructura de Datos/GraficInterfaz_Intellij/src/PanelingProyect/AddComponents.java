...
public class AddComponents{
   ...
   public void addJTextField(JTextField textField, int gx, int gy, double width, double height, int top, int left, int bottom, int right, int gridwidth, int gridheight, int fill) {
      // Configurar GridBagConstraints
